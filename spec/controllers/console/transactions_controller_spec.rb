...
RSpec.describe Console::TransactionsController, type: :controller do
  ...
  describe 'DELETE #destroy' do
    ...
    context 'when the user is not authorized' do
      ...
      let(:other_transaction) { create(:transaction, account: other_account, category: other_category) }

      it 'raises a ActiveRecord::RecordNotFound' do
        expect {
          delete :destroy, params: { account_id: account.id, id: other_transaction.id }
